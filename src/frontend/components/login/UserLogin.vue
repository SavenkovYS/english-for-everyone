<template>
    <div class="user-login">
        <header class="user-login__header">
            <svg class="user-login__logo" height="50" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 445.953 445.953" style="enable-background:new 0 0 445.953 445.953;" xml:space="preserve">
                <g>
            ...
            <p class="user-login__logo-text">
                <span class="user-login__logo-text-block">English for</span>
                <span class="user-login__logo-text-block">everyone</span>
            </p>
        </header>
        <form class="user-login__form" @submit.prevent>
            <base-text-input
            ...
            />
            <div class="user-login__controls">
                <NuxtLink class="user-login__signup-link" to="/signup">Зарегистрироваться</NuxtLink>
                <base-button class="user-login__login-button">Войти</base-button>
            </div>
        </form>
    </div>
</template>
...
.user-login {
    ...
    &__signup-link:hover,
    &__signup-link:focus-within {
        color: rgba($clr-accent, 0.8);
    }

    &__signup-link:active {
        color: rgba($clr-accent, 0.5);
    }
